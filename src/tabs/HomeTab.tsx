...
export const HomeTab = memo(function HomeTab({
  ...
  return (
    <div className="pb-32">
      {/* Header - Refined */}
      <header className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-black via-gray-900 to-black mb-8 shadow-2xl">
        {/* Decorative elements */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-0 left-0 w-32 h-32 bg-[#E0245E] rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#1D9BF0] rounded-full blur-3xl" />
        </div>
      ...
      <div className="flex gap-2 mb-4 overflow-x-auto pb-2 scrollbar-hide">
        <button
          ...
          className="flex-shrink-0 px-3 py-2 text-[10px] font-bold uppercase border-2 border-[#E0245E] text-[#E0245E] hover:bg-[#E0245E] hover:text-white transition-all whitespace-nowrap"
        >
          💕 {t('DATE_NIGHT')}
        </button>
        {hasActiveFilters && (
          <button
            ...
            className="flex-shrink-0 px-3 py-2 text-[10px] font-bold uppercase border border-gray-400 text-gray-500 hover:border-black hover:text-black transition-all"
          >
            ✕ CLEAR
          </button>
        )}
      ...
      <div className="mb-6 max-h-64 overflow-y-auto border-t-2 border-b-2 border-black/10">
        {displayList.length === 0 ? (
          <EmptyState 
            emoji="🎬"
            title={t('EMPTY_LIST')} 
            message="Add movies or TV shows to get started with your roulette!"
          />
        ) : (
      ...
      <button
        ...
        className="w-full relative overflow-hidden bg-gradient-to-r from-[#E0245E] via-[#FF4081] to-[#E0245E] text-white py-5 text-xl font-black uppercase tracking-wider rounded-xl hover:shadow-xl active:scale-[0.98] transition-all disabled:opacity-50 disabled:from-gray-400 disabled:to-gray-500 group"
      >
        {/* Shimmer effect */}
