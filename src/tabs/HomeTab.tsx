...
export const HomeTab = memo(function HomeTab({
  ...
  return (
    <div className="pb-32">
      {/* Header */}
      <header className="relative overflow-hidden border-8 border-black bg-[#EFEEE5] shadow-2xl mb-6">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute inset-0 bg-gradient-to-br from-[#E0245E]/20 via-transparent to-[#1D9BF0]/20" />
        </div>
        <div className="relative p-8 text-center">
          <h1 className="text-5xl font-black tracking-tighter leading-none">
            <span className="block text-[#E0245E]">MOVIE</span>
            <span className="block -mt-3 text-black">ROULETTE</span>
          </h1>
          <p className="text-[11px] uppercase tracking-widest mt-4 text-black/70 font-bold">
            {t('SUBTITLE')}
          </p>
          {winCount > 0 && (
            <p className="text-[9px] uppercase text-gray-500 mt-2">
      ...
      <button
        ...
        className="w-full bg-black text-[#EFEEE5] py-6 text-2xl font-black uppercase tracking-widest hover:bg-gray-900 active:scale-95 transition-transform disabled:opacity-50"
      >
