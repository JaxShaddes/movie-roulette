...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#EFEEE5] text-black relative font-mono select-none">
      ...
      {/* WINNER MODAL - Enhanced celebration */}
      {showResult && selectedItem && !isSpinning && (
        ...
        >
          <div
            className="bg-gradient-to-b from-gray-900 to-black text-white overflow-hidden shadow-2xl relative animate-bounce-in w-full max-w-md rounded-2xl border-4 border-white/20"
          ...
          >
            ...
            <div className="relative z-10 p-6">
              ...
              <div className="text-center mb-6">
                <div className={`inline-block px-4 py-2 rounded-full text-sm font-bold tracking-widest uppercase animate-pulse-glow ${
                  winCount === 1 
                    ? 'bg-gradient-to-r from-[#E0245E] to-[#FF69B4] text-white' 
              ...
              <button
                ...
                className="w-full mt-6 px-6 py-4 bg-white text-black rounded-xl text-sm font-bold uppercase tracking-wider hover:bg-gray-100 transition-all active:scale-98 shadow-lg"
              >
                ✓ {t('BTN_WATCHED')}
              </button>
      ...
      {/* SPINNING OVERLAY - More dramatic */}
      {isSpinning && (
        <div className="fixed inset-0 z-[60] bg-black flex items-center justify-center">
          <div className="text-center px-8">
            {/* Pulsing ring */}
            <div className="relative w-32 h-32 mx-auto mb-8">
              <div className="absolute inset-0 rounded-full border-4 border-[#E0245E]/30 animate-ping" />
              <div className="absolute inset-2 rounded-full border-4 border-[#E0245E]/50 animate-pulse" />
              <div className="absolute inset-4 rounded-full border-4 border-[#E0245E] flex items-center justify-center">
                <span className="text-4xl">🎰</span>
              </div>
            </div>
            
            <p className="text-sm uppercase text-[#E0245E] mb-3 tracking-[0.3em] font-bold animate-pulse">
              {t('SPINNING')}
            </p>
