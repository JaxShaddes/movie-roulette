...
export const Toast = memo(function Toast({ msg }: ToastProps) {
  return (
    <div
      className="animate-toast bg-[#1a1a1a] text-[#EFEEE5] px-5 py-3 rounded-xl shadow-xl font-semibold text-sm flex items-center gap-3"
      role="alert"
    >
...
export const PosterImage = memo(function PosterImage({
  ...
  if (!path) {
    return (
      <div
        className={cn(
          'bg-gray-200 flex items-center justify-center text-gray-400 rounded-xl',
          className
        )}
...
interface EmptyStateProps {
  icon?: 'list' | 'bookmark' | 'search' | 'history' | 'film';
  title: string;
  message?: string;
...
const EmptyStateIcons = {
  ...
  history: <path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/>,
...
export const EmptyState = memo(function EmptyState({ icon = 'list', title, message, action }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-8 text-center animate-fade-in">
      ...
      <h3 className="font-mono text-sm font-bold uppercase tracking-widest mb-2 text-gray-800">{title}</h3>
